...
3	OO	Draw with OO program	75
6	Turtle	Practice with mazes and algorithms	90
7	API	Create Eventbrite invitation for Balloonicorn with AP	80
4	html	Practice with html, Flask, and Jinja	100
\.
